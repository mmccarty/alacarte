...
describe Master do
  ...
  it 'should elide the current guide from the list of published guides' do
    ...
    guide  = guides[1]
    guides.delete guide
    expect(master.pub_guides guide.id).to eq(guides.sort_by { |guide| guide.guide_name })
  end
end
