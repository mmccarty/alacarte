module AdminHelper
  def next_master
    link_to_function image_tag("icons/add.png", :title => 'Click to add a 1 more Master', :alt => '', :border => 0 )+" Add 1 more" do |page|
  ...
  def next_subject
    link_to_function image_tag("icons/add.png", :title => 'Click to add a 1 more Subject', :alt => '', :border => 0 )+" Add 1 More" do |page|
