...
class Uploadable < ActiveRecord::Base
  ...
  def logo
    if upload_content_type == 'application/pdf'
      ...
      return logo =  "icons/ppt.png", title = _("Download free alternative to Microsoft Word/Office"), link ="http://www.openoffice.org/"
      ...
      return logo =  "icons/image.png", title = _("Download Free Image Manager"), link ="http://www.gimp.org/"
    else
      return logo_image = "icons/word.png", title = _("Download free alternative to Microsoft Word/Office"), link ="http://www.openoffice.org/"
    end
  end
end
