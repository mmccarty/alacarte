<<<<<<< .mine
ALTER TABLE `users` CHANGE `rid` `resource_id` INT( 11 ) NULL DEFAULT NULL; 
...
CREATE TABLE `assignments` (
  ...
  PRIMARY KEY  (`id`),
  KEY `student_id` (`student_id`,`tutorial_id`),
...
CREATE TABLE `book_resources` (
  `id` int(11) NOT NULL auto_increment,
  `module_title` varchar(55) default 'RSS Feeds',
  `label` varchar(55) default NULL,
  `updated_at` datetime default NULL,
  `content_type` varchar(255) default 'Catalog Links',
...
DROP TABLE IF EXISTS `instructionals`;
CREATE TABLE `instructionals` (
  ...
  `position` int(11) default NULL,
  PRIMARY KEY  (`id`),
  KEY `lesson_id` (`lesson_id`,`chapter_id`)
);
...
CREATE TABLE `resourceables` (
  ...
  PRIMARY KEY  (`id`),
  KEY `resource_id` (`resource_id`,`lesson_id`)
);
...
CREATE TABLE `topics` (
  ...
  `position` int(11) default NULL,
  PRIMARY KEY  (`id`),
  KEY `chapter_id` (`chapter_id`,`unit_id`)
);
...
ALTER TABLE tabs add foreign key (page_id) references pages (id);
...
INSERT INTO image_managers (photo_file_name,created_at,updated_at,photo_updated_at,photo_content_type,photo_file_size) Values ('DSCN0331.jpg',now(),now(),now(),'jpg',29038);
INSERT INTO image_managers (photo_file_name,created_at,updated_at,photo_updated_at,photo_content_type,photo_file_size) Values ('waterfall.jpg',now(),now(),now(),'jpg',22833);
INSERT INTO image_managers (photo_file_name,created_at,updated_at,photo_updated_at,photo_content_type,photo_file_size) Values ('Photo_19.jpg',now(),now(),now(),'jpg',17691);
INSERT INTO image_managers (photo_file_name,created_at,updated_at,photo_updated_at,photo_content_type,photo_file_size) Values ('nichols.jpg',now(),now(),now(),'jpg',17422);
INSERT INTO image_managers (photo_file_name,created_at,updated_at,photo_updated_at,photo_content_type,photo_file_size) Values ('Janet_with_quilt.jpg',now(),now(),now(),'jpg',56619);
INSERT INTO image_managers (photo_file_name,created_at,updated_at,photo_updated_at,photo_content_type,photo_file_size) Values ('DSCN0315.jpg',now(),now(),now(),'jpg',29250);
INSERT INTO image_managers (photo_file_name,created_at,updated_at,photo_updated_at,photo_content_type,photo_file_size) Values ('735_Mellinger_Margaret_093803.jpg',now(),now(),now(),'jpg',2679);
INSERT INTO image_managers (photo_file_name,created_at,updated_at,photo_updated_at,photo_content_type,photo_file_size) Values ('Red.jpg',now(),now(),now(),'jpg',18573);
=======
DROP TABLE IF EXISTS `answers`;
CREATE TABLE `answers` (
  `id` int(11) NOT NULL auto_increment,
...
CREATE TABLE `image_resources` (
  `id` int(11) NOT NULL auto_increment,
  `module_title` varchar(55) NOT NULL,
  `label` varchar(255) default NULL,
  `created_by` varchar(255) default NULL,
  `updated_at` datetime default NULL,
  `information` text,
...
ALTER TABLE lib_resources DROP photo_content_type;
ALTER TABLE lib_resources DROP photo_file_size;
ALTER TABLE lib_resources DROP photo_updated_at;>>>>>>> .r2023
