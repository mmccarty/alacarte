...
def self.up
    ...
    Dod.update_all({:title => ''},{:title => nil})
    Dod.update_all({:url => ''},{:url => nil})
    ...
    change_column :dods,:fulltxt,:string
    change_column :dods,:illreq,:string
  ...
  def self.down
    ...
    change_column :units,:slug,:string,:default => "",:null => false
    ...
    change_column :quiz_resources, :global, :integer, :limit => 1, :default => 0,:null => false
    ...
    change_column :dods,:fulltxt,:string,:limit => 2
    change_column :dods,:illreq,:string,:limit => 2
    change_column :dods,:fssub,:string,:limit => 2
    change_column :dods,:brief,:string,:null => true
    change_column :dods,:visible,:boolean,:default => true
