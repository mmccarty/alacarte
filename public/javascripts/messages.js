...
/*update page*/
GUIDE_NAME_MSSG="Select the broader topic to group the guide under and classes to associate the guide with. If the guide is for a subject, choose the subject(s) it falls under. If the guide is not for a subject than select either How To or General Reference. Select the classes you want to associate this guide with if appropriate."
...
/*Page Messages*/
PAGE_TITLE_MSSG="The title of a page consists of three fields; subject, course number, and course name. The page title is what will appear at the top of the ICA page. The term, year and campus fields are used to organize the pages and to make them more findable. Section number is not required and used as an extra unique identifier. "
...
/*MODULE MESSAGES*/
MOD_TITLE_MSSG= 'This is the module\'s title that will appear on the page/guide.<br /> Enter a  title that better explains the content in this module. The title should be a maximum of 55 characters.'
...
/*Database Module*/
DB_MSSG = "Below are the databases selected for this module. You can edit the description of the databases (the coverage dates are already included), reorder how the databases are displayed, or select a database to remove it from the module. Remember to save the module afterwards."
DB_INFO_MSSG ='Enter general information about the module or the databases. Use the formatting icons to format it. If you are unfamiliar with the rich text editor, click on the <b>Help</b> link at the top of this page and read the \'How Do I Use the Rich-text Editor\' help topic.'
...
ASSIGN_DESC_MSSG= 'Enter a description of the assignment. Use the formatting icons to format it. If you are unfamiliar with the rich text editor, click on the <b>Help</b> link at the top of this page and read the \'How Do I Use the Rich-text Editor\' help topic.'

/*RSS MODULE */
RSS_MSSG ="Locate the RSS feed  on the website. Enter the URL of the RSS feed (include the http:// part, or other appropriate protocol). Please verify that the address presents raw XML. Some RSS feeds do not validate and will fail to display on the page. "
...
WIDGET_INFO_MSSG ='Enter information about the widget. Use the formatting icons to format it. If you are unfamiliar with the rich text editor, click on the <b>Help</b> link at the top of this page and read the \'How Do I Use the Rich-text Editor\' help topic.'

/*Custom Content*/
CUSTOM_MSSG ='Enter custom content here. Use the formatting icons to format it. If you are unfamiliar with the rich text editor, click on the <b>Help</b> link at the top of this page and read the \'How Do I Use the Rich-text Editor\' help topic.'
POP_UP_MSSG ='Click yes if you want to add a link to a more information pop-up. You can add longer content to the pop-up. '
MORE_MSSG= 'Enter content that appears in a pop-up. Use the formatting icons to format it. If you are unfamiliar with the rich text editor, click on the <b>Help</b> link at the top of this page and read the \'How Do I Use the Rich-text Editor\' help topic.' 
...
/*Course Reserves*/
RESERVES_MSSG='Enter information about course reserves.  Use the formatting icons to format it. If you are unfamiliar with the rich text editor, click on the <b>Help</b> link at the top of this page and read the \'How Do I Use the Rich-text Editor\' help topic.'
RESERVE_LIST_MSSG="Select the items you would like to include on this course page. Duplicate entries mean more than one copy of a particular title is available."
/*Librarian module*/
LIB_NAME = 'Enter the name of the course librarian'
LIB_LOCATE = 'Enter the librarian\'s office location'
LIB_HOURS ='Enter the librarian\'s office hours'
LIB_IMAGE ='Click on the <b>Browse</b> button to upload an image. The image will be displayed at <b>215 x 215 pixels</b>. There is no need to resize your image.'
SELECT_IMAGE ='You can keep your existing image, upload a new image, or remove your image. If you select <i>Remove my image</i> you must still save the page for the change to occur.'
LIB_NEW_IMAGE_MSSG = 'Click on the <b>Browse</b> button to upload a new image. This will replace your current image.'
...
LF_QUERIES_MSSG ='Click yes if you want to display the last 5 search queries'
LF_INFO_MSSG ='Enter information about searching. Use the formatting icons to format it. If you are unfamiliar with the rich text editor, click on the <b>Help</b> link at the top of this page and read the \'How Do I Use the Rich-text Editor\' help topic.'
